...
namespace Boggle
{
    ...
    public static class IISAgent
    {
        ...
        public static void Start(string arguments)
        {
            if (process == null)
            {
                ProcessStartInfo info = new ProcessStartInfo(Properties.Resources.IIS_EXECUTABLE,
                    arguments);
    ...
    public class BoggleTests
    {
        ...
        public void TestPendingStatus()
        {
            ...
            users.Nickname = "Jeb";
            Response q = client.DoPostAsync("users",
                    users)
                .Result;
        ...
        public void TestBasicRegister()
        {
            dynamic users = new ExpandoObject();
            users.Nickname = "Jeb";
            Response r = client.DoPostAsync("users",
                    users)
                .Result;
        ...
        public void JoinInvalidTimeLimit121()
        {
            ...
            users.Nickname = "Joe";
            Response s = client.DoPostAsync("users",
                    users)
                .Result;
            users2.UserToken = s.Data.UserToken;
            users2.TimeLimit = 121;

            Response r = client.DoPostAsync("games",
                    users)
                .Result;
            Assert.AreEqual(Forbidden,
                r.Status);
        ...
        public void JoinAsFirstPlayerAlreadyPendingExpectConflict()
        {
            ...
            Response r = client.DoPostAsync("games",
                    users)
                .Result;
            r = client.DoPostAsync("games",
                    users)
                .Result;
            r = client.DoPostAsync("games",
                    users)
                .Result;
            Assert.AreEqual(Conflict,
                r.Status);
        ...
        public void PlayIncorrectWordBasicTest()
        {
            ...
            q = client.DoPutAsync(userPlayWord,
        ...
        public void PlayWordOnTheBoard()
        {
            ...
            int gameID = q.Data.GameID;
            Response r = client.DoGetAsync("games/" + gameID.ToString())
                .Result;
        ...
        public void PlayWordOnTheBoardTwice()
        {
            ...
            foreach (string s in dictionaryWords)
            {
                if (theBoard.CanBeFormed(s) && s.Length > 2)
                {
                    ...
                    if (users.Score > -1)
                    {
                        Assert.AreEqual(users.Score.ToString(),
                            "0");
                        didItPlay = true;
                        break;
                    }
        ...
        public void TestActiveBrief()
        {
            ...
            dynamic users2 = new ExpandoObject();
            users2.Nickname = "Joe";
            Response q2 = client.DoPostAsync("users",
                    users)
                .Result;
            ...
            Response k = client.DoPostAsync("games",
                    userInfo)
                .Result;
            Response l = client.DoPostAsync("games",
                    userInfo2)
                .Result;
            int gameID = k.Data.GameID;


            Response t = client.DoGetAsync("games/" + gameID + "?brief=yes",
                    "")
                .Result;
        ...
        public void TestCompleteGameState()
        {
            ...
            if (k.Status.Equals(Created))
            {
                while (true)
                {
                    a = client.DoGetAsync("games/" + gameID,
                            "")
                        .Result;

                    if (a.Data.GameState.ToString()
                        .Equals("completed"))
                        break;
                }
            }
            else if (k.Status.Equals(Accepted))
            {
                while (true)
                {
                    ...
                    users3.Nickname = "Joe";
                    Response q3 = client.DoPostAsync("users",
                            users)
                        .Result;
                    ...
                    Response m = client.DoPostAsync("games",
                            userInfo3)
                        .Result;
        ...
        public void TestPendingGame()
        {
            ...
            if (r.Status.Equals(Created))
            {
                ...
                Response r2 = client.DoPostAsync("games",
                        users2)
                    .Result;
        ...
        public void CancelJoin()
        {
            ...
            if (k.Status.Equals(Created))
            {
                ...
                Response k2 = client.DoPostAsync("games",
                        users2)
                    .Result;
                Response r2 = client.DoPutAsync(userTokenInfo2,
                        "games")
                    .Result;
                Assert.AreEqual(OK,
                    r2.Status);
            ...
            {
                Response r = client.DoPutAsync(userTokenInfo,
                        "games")
                    .Result;
                Assert.AreEqual(OK,
                    r.Status);
        ...
        public void TheForbiddenTest()
        {
            ...
            Response a = client.DoPutAsync(userInfo2,
                    "games")
                .Result;
            Response b = client.DoPutAsync(userInfo2,
                    "games/" + gameID)
                .Result;
            Response c = client.DoGetAsync("games/" + (-1),
                    "")
                .Result;
